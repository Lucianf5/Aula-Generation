package ProjetoModulo1;
	...
	public class biblioteca {
		...
		public static void main(String[] args) {
			...
			estoque.add("O sol é para todos");
			estoque.add("Sociedade do cansaço");
			estoque.add("Admiravel mundo novo");
			estoque.add("Em busca de nos mesmo");
			estoque.add("Dracula");
			estoque.add("It - A coisa");
			estoque.add("O Exorcista");
			estoque.add("O cemitério");
			estoque.add("A Troca");
			estoque.add("Como ser mulher");
			estoque.add("A divina comedia");
			estoque.add("Minha vida não tão perfeita");
			estoque.add("O Duque e Eu");
			estoque.add("Anne of Green Gables");
			estoque.add("A cinco passos de você");
			estoque.add("Sol da meia-noite");
					                ...
					                case 2:
					                    ...
					                    try {
					                        ...
					                        do {
					            				...
					            				case 6: 
					            					//emprestimo e devoluções de livros
					            					System.out.printf("Desejo levar os livros: ");
					            					
					            				case 7:
					            					
					            					System.out.println("Desejo devolver os livros: ");
